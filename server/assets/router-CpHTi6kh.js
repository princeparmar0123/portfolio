...
const appCss = "/assets/styles-DzQfbD7v.css";
...
const $$splitComponentImporter = () => import("./index-BRfXHrgC.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Prince Parmar — Flutter Developer with 4+ years building scalable mobile and web applications for startups and enterprise clients."
    }, {
      property: "og:title",
      content: "Prince Parmar — Flutter Developer"
    }, {
      property: "og:description",
      content: "Premium Flutter, Android & cross-platform mobile development. View projects, experience and get in touch."
    }],
    links: [{
      rel: "preconnect",
