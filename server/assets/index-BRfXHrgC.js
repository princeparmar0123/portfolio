import { P as reactExports, H as jsxRuntimeExports } from "./server-Cnb_xRzE.js";
...
const AppWindow = createLucideIcon("app-window", __iconNode$m);
const __iconNode$l = [
          ...
          "nav",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#home", className: "flex items-center gap-2 group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-lg bg-gradient-primary glow-purple group-hover:scale-110 transition-transform" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-1", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                {
                  href: l.href,
                  className: `relative px-3 py-2 text-sm transition-colors rounded-lg ${active === l.href.slice(1) ? "text-white" : "text-muted-foreground hover:text-white"}`,
                  children: [
                    l.label,
                    active === l.href.slice(1) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.span,
                      {
                        layoutId: "nav-dot",
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 -z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 -left-20 w-[28rem] h-[28rem] bg-[oklch(0.5_0.25_290)] rounded-full mix-blend-screen filter blur-[120px] opacity-40 animate-blob" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 -right-20 w-[28rem] h-[28rem] bg-[oklch(0.5_0.25_240)] rounded-full mix-blend-screen filter blur-[120px] opacity-40 animate-blob [animation-delay:-6s]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-1/3 w-[24rem] h-[24rem] bg-[oklch(0.55_0.22_310)] rounded-full mix-blend-screen filter blur-[120px] opacity-30 animate-blob [animation-delay:-12s]" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 14, className: "text-[oklch(0.75_0.2_290)]" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h1,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-white/90", children: "Prince" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-gradient", children: "Parmar" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: titles.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.p,
                {
                  initial: false,
                  animate: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.p,
            {
              ...
              children: [
                ...
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold", children: "4+ years" }),
                " of experience building scalable enterprise and startup applications."
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function SectionHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.span,
      {
        initial: { opacity: 0, y: 10 },
...
const highlights = [
  { icon: CodeXml, label: "Clean Architecture", desc: "Scalable, maintainable codebases." },
  { icon: Rocket, label: "Performance", desc: "Optimized 60fps mobile apps." },
  { icon: Shield, label: "Secure", desc: "Hardened payments & auth flows." }
];
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "relative py-28 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { eyebrow: "About", title: "Building products people love" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-8 items-stretch", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-20 -right-20 w-60 h-60 bg-[oklch(0.5_0.25_290)] rounded-full blur-3xl opacity-20" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg text-white/85 leading-relaxed", children: [
              "I'm a ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient font-semibold", children: "Flutter Developer" }),
              " with 4+ years of experience building scalable, secure, and high-performance mobile and web applications for startups and enterprise clients."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-muted-foreground leading-relaxed", children: "I specialize in Flutter, Kotlin, Firebase, REST APIs, payment gateway integrations, real-time chat systems, Clean Architecture, and scalable mobile application development." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2 grid gap-4", children: highlights.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, x: 30 },
          whileInView: { opacity: 1, x: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-11 rounded-xl bg-gradient-primary flex items-center justify-center shrink-0 glow-purple", children: /* @__PURE__ */ jsxRuntimeExports.jsx(h.icon, { size: 20, className: "text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-white", children: h.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: h.desc })
            ] })
          ]
        },
        h.label
...
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "relative py-28 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
        eyebrow: "Tech Stack",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3", children: skills.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-0.5 bg-gradient-primary rounded-xl opacity-0 group-hover:opacity-100 blur transition-opacity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative px-5 py-2.5 glass rounded-xl text-sm font-medium text-white/85 group-hover:text-white", children: s })
        ]
      },
      s
    )) })
...
function Experience() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", className: "relative py-28 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { eyebrow: "Journey", title: "Experience timeline" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 sm:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[oklch(0.5_0.2_270)] to-transparent" }),
      experience.map((exp, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          transition: { duration: 0.5 },
          className: `relative mb-12 sm:mb-16 flex ${i % 2 === 0 ? "sm:justify-start" : "sm:justify-end"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 sm:left-1/2 top-6 -translate-x-1/2 size-4 rounded-full bg-gradient-primary glow-purple ring-4 ring-[#050816]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `pl-14 sm:pl-0 sm:w-[calc(50%-2rem)] ${i % 2 === 0 ? "sm:pr-12" : "sm:pl-12"}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-2xl p-6 hover:bg-white/[0.06] transition-colors", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-[oklch(0.75_0.2_290)] mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 12 }),
                    exp.duration
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-white text-lg", children: exp.role }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-3", children: exp.company }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: exp.points.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "text-sm text-white/75 flex gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[oklch(0.75_0.2_290)] mt-1.5", children: "•" }),
                    p
                  ] }, p)) })
                ] })
              }
...
const projects = [
  {
    ...
    description: "Friends-first social app where the default feed shows only posts from people you know. Hyperlocal discovery for city-wise posts and communities, with reactions, stories, and in-app purchases.",
    gradient: "from-fuchsia-500/30 to-purple-500/30",
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.biztoso.app&hl=en_IN"
  },
  {
    title: "Event Elite",
    tech: ["Kotlin", "Stripe"],
    description: "Event ticketing platform where admins create and publish events, attendees browse and purchase tickets in-app, and organizers track sales, payouts, and transaction history in one place.",
    gradient: "from-rose-500/30 to-indigo-500/30"
  },
  {
    title: "Anavasi mapp",
    tech: ["Flutter", "GPS", "In-App Purchase"],
    description: "Offline topo map viewer for Greece hiking and touring routes. GPS positioning without network, custom waypoints with photos, difficulty-coded trails, and emergency SMS with live coordinates.",
    gradient: "from-emerald-500/30 to-teal-500/30",
    playStoreUrl: "https://play.google.com/store/apps/details?id=gr.anavasieditions.pavla.anavasimapp&hl=en"
  },
  {
    title: "Agri Tech Solution",
    tech: ["Flutter", "REST APIs", "Payments"],
    description: "Agricultural marketplace helping farmers order certified pesticides, fertilizers, and growth products from verified suppliers—with secure checkout, delivery tracking, and multilingual support.",
    gradient: "from-lime-500/30 to-green-500/30",
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.agriorganic&hl=en"
  },
  {
    title: "Kswift Services",
    tech: ["Flutter", "Firebase", "Real-time Tracking"],
    description: "Vehicle service platform connecting drivers with verified mechanics. Live service updates with photos, transparent pricing, genuine spare parts, and doorstep pickup and drop for cars and bikes.",
    gradient: "from-orange-500/30 to-amber-500/30",
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.kswiftservice&hl=en"
  },
  {
    title: "Drive Now",
    tech: ["Flutter", "Razorpay", "UPI"],
    description: "Self-drive car rental platform for Ahmedabad. Smart filters, doorstep delivery and pickup, seamless UPI and card payments, trip scheduling, and 24/7 support for renters and car hosts.",
    gradient: "from-violet-500/30 to-blue-500/30",
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.freedomride&hl=en_IN"
  }
];
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "relative py-28 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-6xl font-bold text-white/15 group-hover:scale-110 transition-transform duration-700", children: p.title.charAt(0) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[#050816] via-transparent to-transparent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-px left-6 right-6 h-px bg-gradient-to-r from-transparent via-[oklch(0.65_0.22_290)] to-transparent opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-xl text-white mb-2 group-hover:text-gradient transition-colors", children: p.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: p.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-5", children: p.tech.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: "playStoreUrl" in p && p.playStoreUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: p.playStoreUrl,
                target: "_blank",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none", style: {
...
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "relative py-28 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
        eyebrow: "What I Do",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-4", children: services.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-10 -top-10 size-32 rounded-full bg-gradient-primary opacity-0 group-hover:opacity-20 blur-2xl transition-opacity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative size-11 rounded-xl glass flex items-center justify-center mb-4 group-hover:bg-gradient-primary transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { size: 20, className: "text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "relative font-semibold text-white mb-1.5", children: s.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "relative text-sm text-muted-foreground", children: s.desc })
        ]
      },
      s.title
    )) })
...
function Stats() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 30 },
      whileInView: { opacity: 1, y: 0 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-32 left-1/2 -translate-x-1/2 w-[40rem] h-[20rem] bg-[oklch(0.5_0.25_270)] rounded-full blur-3xl opacity-25" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8 relative", children: stats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl sm:text-5xl font-bold text-gradient", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Counter, { to: s.value, suffix: s.suffix }) }),
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "relative py-28 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-24 -left-24 size-72 bg-[oklch(0.5_0.25_240)] rounded-full blur-3xl opacity-25" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-lg bg-gradient-primary flex items-center justify-center glow-purple", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 18, className: "text-white" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Email" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white truncate", children: "princeparmar0234@gmail.com" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                className: "relative group flex items-center gap-3 p-4 rounded-xl glass hover:bg-white/[0.06] transition-colors",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-lg bg-gradient-primary flex items-center justify-center glow-purple", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 18, className: "text-white" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Phone" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white truncate", children: "+91 9016455487" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-lg bg-gradient-primary flex items-center justify-center glow-purple", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { size: 18, className: "text-white" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "GitHub" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white", children: "@princeparmar0123" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                className: "relative flex items-center gap-3 p-4 rounded-xl glass hover:bg-white/[0.06] transition-colors",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-lg bg-gradient-primary flex items-center justify-center glow-purple", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { size: 18, className: "text-white" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "LinkedIn" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white", children: "prince-p" })
                  ] })
                ]
              }
            )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.form,
        {
          ...
          children: [
            ...
            status === "error" && errorText ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-400/90", role: "alert", children: errorText }) : null,
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "submit",
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative border-t border-white/5 mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-6 rounded-md bg-gradient-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "© 2026 Prince Parmar. All Rights Reserved." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Crafted with passion · Flutter & beyond" })
  ] }) });
}
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative min-h-screen bg-app text-foreground overflow-x-hidden", children: [
